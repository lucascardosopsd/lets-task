...
const TasksArea = ({ data }: TasksAreaProps) => {
  ...
  return (
    <div className="flex flex-wrap justify-center mobile:justify-start p-4 gap-4 h-screen overflow-y-auto pb-40 ">
      ...
      <button
        className="h-48 w-full hidden mobile:w-48 mobile:flex items-center justify-center rounded border border-zinc-600 text-zinc-600 group hover:border-green-500 text-6xl font-thin transition"
